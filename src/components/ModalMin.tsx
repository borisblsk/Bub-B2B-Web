...
export default function ModalMin({
  isOpen,
  onClose,
  title,
  hasBack = false,
  ...
  return createPortal(
    ...
    >
      <div
        ...
        className={[
          'relative flex flex-col gap-xl p-xl w-[448px] h-[438px]',
        ...
        {title && (
          <div className="flex gap-xs items-center w-full shrink-0">
            ...
            <div className="flex-1 min-w-0">
              <h2
                id={titleId}
                className="text-body-m font-medium text-foreground-primary truncate"
              >
                {title}
              </h2>
            </div>
